namespace PaymentsSdk.USMoneris
{
    ...
    {
        private readonly USTransactionFactory factory;

        protected ICredentials Credentials { get; private set; }

        public bool StatusCheck { get; set; }

        public USGateway(ICredentials credentials)
        {
            this.Credentials = credentials;
            this.factory= new USTransactionFactory();
        }
        ...
        private IReceipt Send(Transaction transaction)
        {
            ...
            return new USReceipt(request.GetReceipt());
        }
    }
}
